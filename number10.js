// JavaScript Objects: Objects in JavaScript are collections of key-value pairs,
//  where each key (or property) is a string and each value can
//  be any data type (number, string, boolean, array, function,etc)
